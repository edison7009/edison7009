...
— 01 · **EchoBird** — built with Claude Code · 把 Claude Code、ChatGPT 等的安装、本地大模型与模型切换，都化成一次幸福的点击

— 02 · **Coffee CLI** — built with Claude Code · 让终端AI工具变成桌面级体验：粘贴图片 · 历史对话 · Git 树提交等

— 03 · **TierVibe** — built with Claude Code · Tier list + 社区，一键生成 TierList 短视频

— 04 · **Open Longevity** — built with Codex · 长寿科技 × AI，让科学延寿普惠化
